...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = providers.environmentVariable("KS_PASS").getOrElse("")
            keyAlias = providers.environmentVariable("KS_ALIAS").getOrElse("easydict")
            keyPassword = providers.environmentVariable("KS_PASS").getOrElse("")
        }
    }
